...
const ListComponent = () => {
  const menuItems = [
    ...
    },
    {
      ...
      id: "call-link",
      dataInfo: "callpage",
      icon: <CallIcon className="menu-icon" />,
    },
    {
      name: "Finance",
      href: "/finance",
      id: "finance-link",
      dataInfo: "financepage",
