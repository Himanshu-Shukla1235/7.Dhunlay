...
const Test = () => {
    const logos = [
        ...
        { src: "https://newsroom.spotify.com/wp-content/themes/ftr/assets/images/Spotify_Logo_RGB_Green.png", alt: "Apple Music" },
        { src: "https://m.media-amazon.com/images/G/01/AmazonMusic/Logos/Parent/Amazon_Music_Black.png", alt: "SoundCloud" },
