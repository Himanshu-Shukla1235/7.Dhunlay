...
2.  This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://dhunlay.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').  
3.  The Platform is owned by HIMANSHU SHUKLA SO PAVAN SHUKLA, a company incorporated under the Companies Act, 1956 with its registered office at Gwalior Smart City Office, Moti Mahal, Madhya Pradesh ,Gwalior ,India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..  
...
13.  All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Gwalior and Madhya Pradesh.  
...
15.  We currently do not offer any refunds once a service or product has been purchased, except in cases where a technical error or billing issue has occurred. If you believe you have been wrongly charged or have a valid reason for a refund request, please contact us at dhunlay2096@gmail.com within 7 days of your transaction. All refund requests will be reviewed on a case-by-case basis and, if approved,credited within 10 business days. 
...
This Privacy Policy describes how HIMANSHU SHUKLA SO PAVAN SHUKLA and its affiliates 
(collectively "HIMANSHU SHUKLA SO PAVAN SHUKLA, we, our, us") collect, use, share, protect 
or otherwise process your information/ personal data through our website https://dhunlay.com/ 
...
any information. If you receive an email, a call from a person/association claiming to be HIMANSHU 
SHUKLA SO PAVAN SHUKLA seeking any personal data like debit/credit card PIN, net-banking or 
mobile banking password, we request you to never provide such information. If you have already 
...
Himanshu Shukla 
Dhunlay  
Office, Moti Mahal, Gwalior Smart City, Madhya Pradesh, India 
Contact us: 
Phone:7489862224  
Email:dhunlay2096@gmail.com 
Time: Monday - Friday (9:00 AM – 6:00 PM)`}</pre>
      </div>
    </div>
  );
};
